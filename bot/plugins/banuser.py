...
#BAN-USER-SYSTEM
@bot.on_message(filters.private & filters.command('ban') & filters.user(Var.ADMINS))
async def add_banuser(client: Client, message: Message):        
    ...
    for uid in banusers:
        ...
        if uid_int in await db.get_all_admins() or uid_int == Var.ADMINS:
...
@bot.on_message(filters.private & filters.command('unban') & filters.user(Var.ADMINS))
...
@bot.on_message(filters.private & filters.command('banlist') & filters.user(Var.ADMINS))
